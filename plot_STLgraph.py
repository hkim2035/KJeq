...
for YYMM in ['2010', '2011', '2012', '2101', '2102', '2103', '2104', '2105']: #, '2106', '2010']:

    df = pd.read_csv(f"C:\\Users\\hyunw\\OneDrive\\Data\\PTsensor\\{site}_{YYMM}_all_P500.csv", sep=',', header=0, skip_blank_lines=True)
    dfrain = pd.read_csv(f"C:\\Users\\hyunw\\OneDrive\\Data\\PTsensor\\KJ_rain_daily.csv", sep=',', header=0, skip_blank_lines=True)
    ...
    for idx, eqvline in eqlist_this.iterrows():
        ...
        axs[3].axvline(x = eqvline.Time, color = eqcolor, linewidth=eqwidth, linestyle = dash)
